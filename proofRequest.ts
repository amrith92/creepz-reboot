const proofRequest = {
    ...
    "body": {
        ...
        "transaction_data": {
            ...
            // <CHANGE THIS>
            "contract_address": "0xbCFEE8065E595D30E811303ce81711EcC9acDc50",
        ...
        "reason": "Creepz Report Submission",
        ...
        "scope": [
            {
                ...
                "rules": {
                    ...
                    "query": {
                        ...
                        // <CHANGE THIS>
                        "schema": {
                            "url": "https://s3.eu-west-1.amazonaws.com/polygonid-schemas/18dfe0ee-e3cf-4ae9-8533-0a74712f32f0.json-ld",
                            "type": "ProofOfLife"
                        }
                    }
                }
